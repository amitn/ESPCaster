...
#ifndef PROTOBUF_C_components_2fchromecast_5fcontroller_2fchromecast_5fprotobuf_2fcast_5fchannel_2eproto__INCLUDED
#define PROTOBUF_C_components_2fchromecast_5fcontroller_2fchromecast_5fprotobuf_2fcast_5fchannel_2eproto__INCLUDED
...
typedef enum _Extensions__Api__CastChannel__HashAlgorithm {
  EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA1 = 0,
  EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA256 = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM)
...
struct  _Extensions__Api__CastChannel__AuthChallenge
{
  ...
  Extensions__Api__CastChannel__HashAlgorithm hash_algorithm;
};
#define EXTENSIONS__API__CAST_CHANNEL__AUTH_CHALLENGE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&extensions__api__cast_channel__auth_challenge__descriptor) \
    , 0, EXTENSIONS__API__CAST_CHANNEL__SIGNATURE_ALGORITHM__RSASSA_PKCS1v15, 0, {0,NULL}, 0, EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA1 }
...
#define EXTENSIONS__API__CAST_CHANNEL__AUTH_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&extensions__api__cast_channel__auth_response__descriptor) \
    , {0,NULL}, {0,NULL}, 0,NULL, 0, EXTENSIONS__API__CAST_CHANNEL__SIGNATURE_ALGORITHM__RSASSA_PKCS1v15, 0, {0,NULL}, 0, EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA1, 0, {0,NULL} }
...
extern const ProtobufCEnumDescriptor    extensions__api__cast_channel__hash_algorithm__descriptor;
...
#endif  /* PROTOBUF_C_components_2fchromecast_5fcontroller_2fchromecast_5fprotobuf_2fcast_5fchannel_2eproto__INCLUDED */
