...
/* Generated from: components/chromecast_controller/chromecast_protobuf/cast_channel.proto */
...
static const Extensions__Api__CastChannel__HashAlgorithm extensions__api__cast_channel__auth_challenge__hash_algorithm__default_value = EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA1;
static const ProtobufCFieldDescriptor extensions__api__cast_channel__auth_challenge__field_descriptors[3] =
{
  {
    "signature_algorithm",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BYTES,
    offsetof(Extensions__Api__CastChannel__AuthChallenge, has_sender_nonce),
    offsetof(Extensions__Api__CastChannel__AuthChallenge, sender_nonce),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_ENUM,
    offsetof(Extensions__Api__CastChannel__AuthChallenge, has_hash_algorithm),
    offsetof(Extensions__Api__CastChannel__AuthChallenge, hash_algorithm),
    &extensions__api__cast_channel__hash_algorithm__descriptor,
    &extensions__api__cast_channel__auth_challenge__hash_algorithm__default_value,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
};
...
static const Extensions__Api__CastChannel__HashAlgorithm extensions__api__cast_channel__auth_response__hash_algorithm__default_value = EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA1;
static const ProtobufCFieldDescriptor extensions__api__cast_channel__auth_response__field_descriptors[7] =
{
  {
    "signature",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BYTES,
    offsetof(Extensions__Api__CastChannel__AuthResponse, has_sender_nonce),
    offsetof(Extensions__Api__CastChannel__AuthResponse, sender_nonce),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_ENUM,
    offsetof(Extensions__Api__CastChannel__AuthResponse, has_hash_algorithm),
    offsetof(Extensions__Api__CastChannel__AuthResponse, hash_algorithm),
    &extensions__api__cast_channel__hash_algorithm__descriptor,
    &extensions__api__cast_channel__auth_response__hash_algorithm__default_value,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_BYTES,
    offsetof(Extensions__Api__CastChannel__AuthResponse, has_crl),
    offsetof(Extensions__Api__CastChannel__AuthResponse, crl),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const ProtobufCEnumValue extensions__api__cast_channel__hash_algorithm__enum_values_by_number[2] =
{
  { "SHA1", "EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA1", 0 },
  { "SHA256", "EXTENSIONS__API__CAST_CHANNEL__HASH_ALGORITHM__SHA256", 1 },
};
static const ProtobufCIntRange extensions__api__cast_channel__hash_algorithm__value_ranges[] = {
{0, 0},{0, 2}
};
static const ProtobufCEnumValueIndex extensions__api__cast_channel__hash_algorithm__enum_values_by_name[2] =
{
  { "SHA1", 0 },
  { "SHA256", 1 },
};
const ProtobufCEnumDescriptor extensions__api__cast_channel__hash_algorithm__descriptor =
{
  PROTOBUF_C__ENUM_DESCRIPTOR_MAGIC,
  "extensions.api.cast_channel.HashAlgorithm",
  "HashAlgorithm",
  "Extensions__Api__CastChannel__HashAlgorithm",
  "extensions.api.cast_channel",
  2,
  extensions__api__cast_channel__hash_algorithm__enum_values_by_number,
  2,
  extensions__api__cast_channel__hash_algorithm__enum_values_by_name,
  1,
  extensions__api__cast_channel__hash_algorithm__value_ranges,
  NULL,NULL,NULL,NULL   /* reserved[1234] */
};
